...
const DELETED_FILE = () => path.join(CONTENT_DIR, 'messages-deleted.json')
...
function readDeletedUids() { const f=DELETED_FILE(); return new Set(fs.existsSync(f) ? JSON.parse(fs.readFileSync(f)) : []) }
function markUidsDeleted(uids) {
  const f = DELETED_FILE(); const s = readDeletedUids()
  uids.forEach(u => s.add(String(u)))
  fs.writeFileSync(f, JSON.stringify([...s]))
}
...
async function fetchInbox(acct) {
  ...
  const deletedSet = readDeletedUids()
...
seedIfMissing('insights-data.json', {
  items: [
    {
      slug: 'restraint-as-a-design-strategy',
      title: 'Restraint as a Design Strategy',
      category: 'Identity Design',
      date: '2023-10-01',
      excerpt: "The hardest design decisions aren't what to add — they're what to remove. Architectural restraint as a discipline means trusting negative space, trusting the reader, and trusting the work itself.",
      image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuApiyh_3aaVjPbYqtnEYBYYCxdU270rhO_lQ0MlcPYGhxDlpPR1GJwvBolsdfXepO0m06UPWAFYvjKsHqwNyFnFZ8UzBq5qUYEMMzTm-PNLwhrRHkmHx-0UsTIVuo9CyfbyQq9j_TjkVdQJRQWNO7S__j6X-y8v3yxbf9p0MDfFO-3s9aIJzbpP4pDagWdhgpBHAFHN_BxkoMOkfgk9ur5yvt6DpaCaGorEo70Rhca1Zi8Pwd7VKUoRiXpeOMhV3pwXoZA8xxFUikw',
      bodyTitle: '',
      body: '<div class="prose-article"><h2 class="font-display text-[32px] uppercase leading-tight mb-6">The Pressure to Fill</h2><p class="text-base text-on-surface-variant leading-relaxed mb-8">There is an almost universal pressure in design to fill space. To add another element, another texture, another colour. Blank space feels unfinished. Clients ask what\'s missing. Designers feel guilty for leaving room. This pressure is almost always wrong.</p><p class="text-base text-on-surface-variant leading-relaxed mb-8">The impulse to add is understandable. Adding things feels like progress. It feels like value. But in identity design specifically, addition is usually the enemy. Every element you add is a claim on the viewer\'s attention. Every unnecessary claim dilutes the ones that matter.</p></div><div class="prose-article"><h2 class="font-display text-[32px] uppercase leading-tight mb-6 mt-16">Negative Space as Signal</h2><p class="text-base text-on-surface-variant leading-relaxed mb-8">Negative space isn\'t empty. It\'s active. It\'s the breath between words that makes sentences comprehensible. It\'s the silence between musical notes that gives rhythm its shape. In visual design, negative space creates emphasis by removing competition. When there\'s nothing else to look at, the thing that remains becomes important.</p><p class="text-base text-on-surface-variant leading-relaxed mb-8">The brands that endure — the ones that feel authoritative and certain — almost universally use negative space as a primary design tool. They\'ve learned that confidence doesn\'t come from filling every square centimetre. It comes from knowing exactly what to show and what to withhold.</p></div><div class="prose-article"><h2 class="font-display text-[32px] uppercase leading-tight mb-6 mt-16">The Discipline of Removal</h2><p class="text-base text-on-surface-variant leading-relaxed mb-8">Restraint is a discipline because it requires active resistance. You have to say no to the gradient when a flat colour works. No to the decorative border when none is needed. No to the second typeface when one is sufficient. Each no is a decision — and decisions require confidence.</p><p class="text-base text-on-surface-variant leading-relaxed mb-8">This is where restraint becomes strategic. When you remove everything non-essential, what remains has to work harder. Every element carries more weight. This forced clarity often reveals whether the underlying concept is actually strong. If removing decoration makes the design feel empty, the problem was never decoration — it was the idea.</p></div><div class="prose-article"><h2 class="font-display text-[32px] uppercase leading-tight mb-6 mt-16">Trust the Work</h2><p class="text-base text-on-surface-variant leading-relaxed">The final act of restraint is trusting the reader. Design that over-explains doesn\'t trust its audience. Design that adds visual complexity to signal effort doesn\'t trust itself. The most confident design does the minimum necessary and then stops. It trusts that the right viewer will understand. It trusts that understanding will be enough.</p></div>',
      status: 'published',
      blocks: [],
      archivedBlocks: [],
    },
    {
      slug: 'the-grid-beneath-everything',
      title: 'The Grid Beneath Everything',
      category: 'Typography',
      date: '2024-02-01',
      excerpt: "Typographic grids aren't about constraint — they're about creating a framework flexible enough to hold any content while maintaining visual authority. How spatial systems become creative tools.",
      image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBga90sr654rVPGPEaB3kJeifl98bSDxlZBsKWfUjsSFqSEteMcDzxZ2X8DI9wNnkiRQXmSPw2yPmztXBYxqj0GuDwUG1Acgtf8ZsPJYMCoHKuPOAdAK38hAzLpvGLwdL5W3U-6cG6Sc8hV6n30pgK_smwSP8kievA0z2dr8GJOsyctxdUC5RCqkfCnoZM-gaS6sG0aXQwWmbDLjY9nGrNFCRA_fLcJJEN4pNxaLHdDkwIZkpTEijUa6bP7s3cbA-WYecL_HK6Yg_0',
      bodyTitle: '',
      body: '<div class="prose-article"><h2 class="font-display text-[32px] uppercase leading-tight mb-6">The Invisible Architecture</h2><p class="text-base text-on-surface-variant leading-relaxed mb-8">Every piece of design exists in space. The question isn\'t whether there\'s a spatial logic at work — there always is. The question is whether that logic was designed deliberately or arrived at by accident. The grid makes the decision visible, and in doing so, it makes it defensible.</p><p class="text-base text-on-surface-variant leading-relaxed mb-8">The Swiss typographers of the mid-20th century understood this. Müller-Brockmann, Ruder, Weingart — they weren\'t constraining design, they were liberating it. By fixing the structural rules, they freed designers to focus on expression. The grid wasn\'t a cage; it was a foundation.</p></div><div class="prose-article"><h2 class="font-display text-[32px] uppercase leading-tight mb-6 mt-16">Hierarchy as Language</h2><p class="text-base text-on-surface-variant leading-relaxed mb-8">A typographic grid creates hierarchy, and hierarchy creates meaning. When a reader\'s eye moves through a page — or a screen — it follows a path. That path is either designed or it isn\'t. If it isn\'t, the reader gets lost. If it is, the designer is communicating before a single word is read.</p><p class="text-base text-on-surface-variant leading-relaxed mb-8">The scale of type — the relationship between headline, subhead, body, and caption — tells the reader what matters most. The spacing between elements tells them where one idea ends and another begins. The margins tell them where the content lives in relation to the world outside it.</p></div><div class="prose-article"><h2 class="font-display text-[32px] uppercase leading-tight mb-6 mt-16">Flexibility Within Structure</h2><p class="text-base text-on-surface-variant leading-relaxed mb-8">The best grids aren\'t rigid — they\'re modular. A 12-column grid can hold a 4-column layout and a 3-column layout and a 2-column layout within the same system. The constraint is the unit, not the configuration. This is what makes spatial systems creative tools rather than limitations.</p><p class="text-base text-on-surface-variant leading-relaxed">When the grid is internalized — when designers stop thinking about it and start thinking through it — it becomes invisible. The work looks effortless. That effortlessness is the result of rigorous, invisible structure. The grid is beneath everything. Always.</p></div>',
      status: 'published',
      blocks: [],
      archivedBlocks: [],
    },
    {
      slug: 'why-brand-systems-outlast-assets',
      title: 'Why Brand Systems Outlast Assets',
      category: 'Brand Strategy',
      date: '2024-05-01',
      excerpt: "The difference between a brand that scales and one that fragments isn't budget — it's whether the thinking behind every visual decision is systematic or intuitive. Systems compound. Assets decay.",
      image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDOWQNwCA_Sy3BPn64hPnpoO02uP_2_I6oW5rpYeyhmhbJcwdODE21QCKmNBnLYpjNRQvkZI7H-37UsPWD4dPdVF7KLHyKL4fMT6LjMz1R1Riqe4PDbEd8ECAxfvke5UBMQ2RnMElW_xDtjq2oan1PCWh863-eSkEa-k_8ihQV0Ww3edsCB43nZJJJqts4HseBRGEvomTagI29z3PqwNDUNQddqSueZb4rURX2KArszCjq8N-BVQXNl1h9vIjUAO0ihvRIynh-y3AM',
      bodyTitle: '',
      body: '<div class="prose-article"><h2 class="font-display text-[32px] uppercase leading-tight mb-6">The Asset Trap</h2><p class="text-base text-on-surface-variant leading-relaxed mb-8">Most brands start with assets. A logo. A color. A tagline. These feel like progress — they are tangible, presentable, and immediately useful. But assets without architecture are just decoration. They exist in isolation, disconnected from a governing logic that tells every designer, writer, and strategist what to do next.</p><p class="text-base text-on-surface-variant leading-relaxed mb-8">The problem reveals itself under pressure. When the brand needs to expand — into a new product line, a new market, a new medium — there\'s no framework to extend. Decisions get made on instinct. The new work looks different. The brand fragments.</p></div><div class="prose-article"><h2 class="font-display text-[32px] uppercase leading-tight mb-6 mt-16">What a System Actually Is</h2><p class="text-base text-on-surface-variant leading-relaxed mb-8">A brand system isn\'t a style guide. Style guides document decisions. Systems explain the principles behind those decisions — and in doing so, they make future decisions obvious. A system answers the question: "If we\'ve never seen this situation before, what would we do?"</p><p class="text-base text-on-surface-variant leading-relaxed mb-8">A strong system has three components. First, a core idea — the single, irreducible truth that the brand stands for. Second, a structural grammar — the rules of how visual elements relate to each other. Third, a set of constraints that make the brand feel consistent without making it feel rigid.</p></div><div class="prose-article"><h2 class="font-display text-[32px] uppercase leading-tight mb-6 mt-16">Compounding Returns</h2><p class="text-base text-on-surface-variant leading-relaxed mb-8">Systems create compounding returns because every new asset reinforces the whole. When the typographic scale is fixed, a new headline looks right immediately. When the color relationships are defined, a new campaign feels on-brand without extra effort. Each new execution adds to the coherence of the brand rather than diluting it.</p><p class="text-base text-on-surface-variant leading-relaxed mb-8">Assets, by contrast, depreciate. They age. They reference a moment in time — a cultural mood, a design trend, a business context. Assets need to be refreshed. Systems evolve without breaking.</p></div><div class="prose-article"><h2 class="font-display text-[32px] uppercase leading-tight mb-6 mt-16">The Practical Implication</h2><p class="text-base text-on-surface-variant leading-relaxed mb-8">Build the logic before you build the look. Understand what the brand is trying to say before deciding how it should appear. Invest in the rules that will govern thousands of future decisions — not just the immediate deliverable.</p><p class="text-base text-on-surface-variant leading-relaxed">This is slower at the start. It requires more thinking, more abstraction, more resistance to the urge to produce something immediately visible. But brands built on systems survive. Brands built on assets get redesigned every three years.</p></div>',
      status: 'published',
      blocks: [],
      archivedBlocks: [],
    },
...
function footerHTML() {
  return `  <footer class="bg-primary text-background px-10 md:px-[80px]">
    ...
    <div class="py-6 flex items-center justify-center gap-8"><span class="text-[10px] text-background/50 uppercase tracking-widest" data-footer-copyright>© 2024 Eyuel Mulat</span><a href="/terms.html" class="text-[10px] text-background/50 uppercase tracking-widest hover:text-background/80 transition-colors">Terms &amp; Conditions</a></div>
  </footer>`
}
